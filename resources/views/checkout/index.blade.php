        ...
        <form id="payment-form">
            ...
            <div class="mb-4">
                <label for="payment_method_card" class="inline-flex items-center">
                    ...
                    <span class="ml-2">Tarjeta de Crédito (Simulada)</span>
                </label>
            </div>
            <div class="mb-4">
                <label for="payment_method_paypal" class="inline-flex items-center">
                    ...
                    <span class="ml-2">PayPal (Simulada)</span>
                </label>
            </div>
...
{{-- Script para simular el pago --}}
<script>
    document.getElementById('payment-form').addEventListener('submit', function(event) {
        event.preventDefault(); // Evita que el formulario se envíe de la manera tradicional.

        const totalAmount = this.querySelector('input[name="total_amount"]').value;
        const csrfToken = this.querySelector('input[name="_token"]').value;

        // Simulación de una respuesta de pago.
        // Aquí puedes agregar validaciones o lógicas de error simuladas.
        ...
        fetch("{{ route('checkout.process') }}", {
            ...
            body: JSON.stringify({
                total: totalAmount,
                // Se puede agregar más información del carrito si es necesario
            }),
        })
        ...
        .then(data => {
            if (data.success) {
                ...
                // Usamos una alerta para simplificar la simulación
                alert('El pago ha fallado: ' + data.message);
            }
        })
        .catch(error => {
